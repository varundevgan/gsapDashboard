...
const Signup = () => {
  ...
  return (
    <div className='w-full relative flex flex-col lg:flex-row  justify-between h-screen bg-gray-900 bg-[url(https://i.postimg.cc/RFqSM2rc/bg.jpg)] bg-no-repeat bg-cover bg-center overflow-hidden'>
        {/* signup */}
            <div id='signup' className={`flex w-full justify-center opacity-0 z-[10] `}>
           ...
           <form onSubmit={signUp} className='flex h-110 sm:h-120 flex-col sm:justify-between'>
                <div className='mb-4'>
                ...
                <div className='w-full flex flex-col sm:flex-row gap-2 items-center justify-between mt-[-20px] mb-2'>
                    ...
                    <div>
                        <span><a onClick={showSignupPage} className='text-white decoration-none text-[16px]' href="#">Login Account !</a></span>
                    </div>
                </div>
                <div>
                    <button className='w-full bg-white text-black py-2.5 px-5 rounded-[50px] font-bold mt-2 sm:mt-0 cursor-pointer' type='submit'>Sign Up</button>
                </div>
                <div></div>
           </form>
        </div>
        ...
        {/* big balls */}
        <div id='bigBalls' className='w-full h-[90%] top-[-60%] md:top-[-50%] lg:w-[180%] lg:h-[180%] xl:h-[200%] absolute lg:top-[-100%] lg:left-[-125%]  bg-white rounded-full z-[1]'>
        ...
        {/* login */}
           ...
           <form onSubmit={login} className='flex h-110 sm:h-120 flex-col justify-between'>
                <div>
                ...
                <div className='w-full flex flex-col sm:flex-row items-center justify-between gap-2'>
                    ...
                    <div>
                        <span><a  onClick={showSignupPage} className='text-white decoration-none text-[16px]' href="#">Create Account?</a></span>
                    </div>
                </div>
                <div>
                    <button className='w-full bg-white text-black py-2.5 px-5 rounded-[50px] font-bold cursor-pointer' type='submit'>Login</button>
                </div>
                <div></div>
           </form>
        </div>
